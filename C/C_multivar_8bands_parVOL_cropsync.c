// gcc -Wall -g  -O3 -I$HOME/opencv3_build/install/include C_multivar_8bands_parVOL_cropsync.c -L$HOME/opencv3_build/install/lib -Wl,-rpath=$HOME/opencv3_build/install/lib -lopencv_core -lopencv_highgui -lopencv_imgcodecs -lopencv_imgproc -o C_multivar_8bands_parVOL_cropsync 
...
void *dynfocBand(void *dfbArgs) 
{
    ...
    slave->die = 1; 
    printf("Master thread spent : %lu ms waiting for mutex\n", idle);
